...
// shoutout to
// https://github.com/R-Hidayatullah/archive-viewer/blob/master/external/bink2/include/bink.h
// i'm almost certain DC3 did not use a version of bink from 2014 (lol, lmao)
// but this is what was publicly available, so it'll do for now
...
EXPGROUP(_NullGroup)
#define BinkDate    "2014-02-05" EXPMACRO    

#define Bink2Version "2.4a"
#define Bink2MajorVersion    2    
#define Bink2MinorVersion    4
#define Bink2BuildNumber     0
#define Bink2Customization   0

#define Bink1Version "1.994a"     EXPMACRO        
...
#define BinkVersion "2.4a/1.994a" EXPMACRO        
#define BinkMajorVersion     0    EXPMACRO    
#define BinkMinorVersion     4    EXPMACRO    
#define BinkBuildNumber      0    EXPMACRO     
